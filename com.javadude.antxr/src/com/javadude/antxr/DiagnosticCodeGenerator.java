...
public class DiagnosticCodeGenerator extends CodeGenerator {
        ...
        try {
            ...
            for (Grammar g : behavior.grammars.values()) {
                ...
                if (antxrTool.hasError()) {
                    antxrTool.fatalError("panic: Exiting due to errors.");
                }
    ...
    public void gen(LexerGrammar g) throws IOException {
        ...
        Iterator<RuleSymbol> ids = grammar.getSymbols();
        while (ids.hasNext()) {
            GrammarSymbol sym = ids.next();
    ...
    protected void genHeader() {
        println("ANTXR-generated file resulting from grammar " + antxrTool.grammarFile);
        println("Diagnostic output");
        println("");
        println("Terence Parr, MageLang Institute");
        println("with John Lilley, Empathy Software");
        println("ANTXR Version " + Tool.version + "; 1989-2005");
        println("");
    ...
    public void genRule(RuleSymbol s) {
        ...
        if (unlabeledUserSpec != null) {
            ...
            for (int i = 0; i < unlabeledUserSpec.handlers.size(); i++) {
                ...
                ExceptionHandler handler = unlabeledUserSpec.handlers.get(i);

...
public class HTMLCodeGenerator extends CodeGenerator {
    ...
    public void gen(CharLiteralElement atom) {
        ...
        _print(HTMLCodeGenerator.HTMLEncode(atom.atomText) + " ");
    }
    ...
    public void gen(LexerGrammar g) throws IOException {
        setGrammar(g);
        antxrTool.reportProgress("Generating " + grammar.getClassName() + ".html");
        currentOutput = antxrTool.openOutputFile(grammar.getClassName() + ".html");
        ...
        if (grammar.comment != null) {
            _println(HTMLCodeGenerator.HTMLEncode(grammar.comment));
        }
    ...
    public void gen(RuleRefElement rr) {
        grammar.getSymbol(rr.targetRule);
...
//	}
    ...
    protected void genHeader() {
        ...
        println("<HTML>");
        println("<HEAD>");
        println("<TITLE>Grammar " + antxrTool.grammarFile + "</TITLE>");
        println("</HEAD>");
        println("<BODY>");
        ...
        println("<a href=\"http://www.com.javadude.antxr.org\">ANTXR</a>-generated HTML file from " + antxrTool.grammarFile);
        println("<p>");
        println("Terence Parr, <a href=\"http://www.magelang.com\">MageLang Institute</a>");
        println("<br>ANTXR Version " + Tool.version + "; 1989-2005");
        println("</td>");
        println("</tr>");
        println("</table>");
        println("<PRE>");
...
//		tabs--;
    ...
    public void genRule(RuleSymbol s) {
        ...
        println("");
        if (s.comment != null) {
            _println(HTMLCodeGenerator.HTMLEncode(s.comment));
        }
    ...
    public void printSet(int depth, int k, Lookahead lookahead) {
        ...
        for (int i = 0; i < elems.length; i++) {
            ...
            if (doingLexRules) {
                ...
                _print(grammar.tokenManager.getVocabulary().get(elems[i]));
            }
            if (i != elems.length - 1) {
                _print(", ");
            }

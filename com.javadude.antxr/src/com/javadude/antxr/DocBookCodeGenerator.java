...
public class DocBookCodeGenerator extends CodeGenerator {
    ...
    public void gen(LexerGrammar g) throws IOException {
        setGrammar(g);
        antxrTool.reportProgress("Generating " + grammar.getClassName() + ".sgml");
        currentOutput = antxrTool.openOutputFile(grammar.getClassName() + ".sgml");
...
//	}
    ...
    protected void genHeader() {
        ...
        println("  <othercredit>");
        println("    <contrib>");
        println("    Generated by <ulink url=\"http://www.ANTXR.org/\">ANTXR</ulink>" + Tool.version);
        println("    from " + antxrTool.grammarFile);
        println("    </contrib>");
        println("  </othercredit>");

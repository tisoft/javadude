...
public abstract class DebuggingCharScanner extends CharScanner implements DebuggingParser {
    ...
    public void consume() throws CharStreamException {
		int la_1 = -99;
		try {la_1 = LA(1);}
		catch (CharStreamException ignoreAnIOException) { /* do nothing */ }
		super.consume();
...
//		}
    ...
    public void match(BitSet b) throws MismatchedCharException, CharStreamException {
		...
		try {
			super.match(b);
			parserEventSupport.fireMatch(la_1, b, textString, inputState.guessing);
		}
		catch (MismatchedCharException e) {
			if (inputState.guessing == 0) {
                parserEventSupport.fireMismatch(la_1, b, textString, inputState.guessing);
            }
			throw e;
		}
	}
    ...
    public void match(String s) throws MismatchedCharException, CharStreamException {
		...
		catch(Exception ignoreMe) { /* do nothing */ }

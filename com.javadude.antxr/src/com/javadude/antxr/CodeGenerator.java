...
/**A generic ANTXR code generator.  All code generators
 ...
 * @version 2.00a
 * @see     com.javadude.antxr.JavaCodeGenerator
 * @see     com.javadude.antxr.DiagnosticCodeGenerator
 * @see     com.javadude.antxr.LLkAnalyzer
 * @see     com.javadude.antxr.Grammar
 * @see     com.javadude.antxr.AlternativeElement
...
public abstract class CodeGenerator {
    ...
    protected List<BitSet> bitsetsUsed;
    ...
    protected String extractIdOfAction(String s, int line, int column) {
        ...
        antxrTool.warning("Ill-formed action", grammar.getFilename(), line, column);
        return "";
    }
        ...
        for (int i = Token.MIN_USER_TYPE; i < v.size(); i++) {
            ...
            if (s != null && !s.startsWith("<")) {
                ...
                if (s.startsWith("\"")) {
                    ...
                    if (ts == null) {
                        antxrTool.warning("undefined token symbol: " + s);
                    }
                    else {
     ...
     */
    public abstract String getASTCreateString(List<String> v);
    ...
    protected int markBitsetForGen(BitSet p) {
        ...
        // Add the new bitset
        bitsetsUsed.add((BitSet) p.clone());
    ...
    private void reset() {
        ...
        bitsetsUsed = new ArrayList<BitSet>();
        currentOutput = null;
        grammar = null;
    ...
    protected void setGrammar(Grammar g) {
        ...
        if (grammar.hasOption("codeGenDebug")) {
            ...
            if (t.getText().equals("true")) {
                ...
                antxrTool.error("option 'codeGenDebug' must be true or false", grammar.getClassName(), t.getLine(), t.getColumn());
            }
        }
    }
